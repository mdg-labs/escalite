// Package grafana implements the Grafana unified alerting inbound plugin.
package grafana
...
func (invalidPayloadError) Error() string { return "invalid grafana webhook payload" }

type noAlertsError struct{}

func (noAlertsError) Error() string { return "grafana webhook contains no alerts" }

type unsupportedVersionError struct{}

func (unsupportedVersionError) Error() string { return "unsupported grafana webhook version" }

type missingFingerprintError struct{}

func (missingFingerprintError) Error() string { return "grafana alert missing fingerprint" }
