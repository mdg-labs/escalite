...
type Querier interface {
	...
	GetStatusPageByID(ctx context.Context, arg GetStatusPageByIDParams) (StatusPage, error)
	GetStatusPageIncidentByID(ctx context.Context, arg GetStatusPageIncidentByIDParams) (StatusPageIncident, error)
	GetStatusPageIncidentUpdateByID(ctx context.Context, arg GetStatusPageIncidentUpdateByIDParams) (StatusPageIncidentUpdate, error)
	...
	ListActiveStatusPageSubscriptions(ctx context.Context, arg ListActiveStatusPageSubscriptionsParams) ([]StatusPageSubscription, error)
