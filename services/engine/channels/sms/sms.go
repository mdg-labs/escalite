...
// New returns the SMS notification channel plugin.
...
func (c *channel) Send(ctx context.Context, params channels.SendParams) error {
	...
	return provider.SendSMS(ctx, smsprovider.SMSParams{
		To:      cfg.PhoneNumber,
		Message: buildMessage(params.Alert),
	})
}
	...
	return json.RawMessage(`{
		...
		"properties": {
			"phone_number": {
				...
				"minLength": 1,
				"title": "Phone number",
				"description": "E.164 phone number for SMS delivery"
			}
		},
