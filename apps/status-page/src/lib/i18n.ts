const messages = {
  ...
  'statusPage.incidents.resolved.title': 'Resolved incidents (last 30 days)',
  'statusPage.incidents.resolved.empty': 'No resolved incidents in the last 30 days.',
  'statusPage.incidents.resolved.count': '{count} resolved',
  'statusPage.incidents.resolvedAt': 'Resolved {date}',
